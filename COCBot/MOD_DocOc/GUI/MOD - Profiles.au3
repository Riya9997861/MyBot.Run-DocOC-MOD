...
Func CreateModProfiles()
	$g_hGUI_MOD_SWITCH = GUICreate("", $_GUI_MAIN_WIDTH - 26, $_GUI_MAIN_HEIGHT - 255 - 28, 5, 25, BitOR($WS_CHILD, $WS_TABSTOP), -1, $g_hGUI_MOD)
	CreateModSwitchAccStyle()

	GUISwitch($g_hGUI_MOD_SWITCH)
	$g_hGUI_MOD_SWITCH_TAB = GUICtrlCreateTab(0, 0, $_GUI_MAIN_WIDTH - 28, $_GUI_MAIN_HEIGHT - 255 - 30, BitOR($TCS_MULTILINE, $TCS_RIGHTJUSTIFY))
...
Func CreateModSwitchAcc()
    ...
    Local $x = 25, $y = 45
	GUICtrlCreateGroup(GetTranslated(637,1, "Switch Profiles"), $x - 20, $y - 20, 430, 65)
		$x -= 5
